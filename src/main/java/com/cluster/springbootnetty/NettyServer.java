...
import com.cluster.springbootnetty.config.ApiServer;
import com.cluster.springbootnetty.config.ApisProperties;
import com.cluster.springbootnetty.request.ServerChannelInitializer;
...
public class NettyServer {
    ...
    public ChannelFuture start() {
        ...
        //Future：异步操作的结果
        ApiServer server = apisProperties.getServer();
